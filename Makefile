...
build: prebuild
	docker run -p 8080:8080 -v ~/mnt/containers/meme_coin:/mnt/containers/meme_coin -e pw=$(pw) -e email=$(email) -e AdminID=$(AdminID) -d --name meme_coin --restart=always meme_coin
testbuild: prebuild
