...
su -c "psql -c 'create table transactions(discord_id VARCHAR(100), amount numeric DEFAULT(0), type VARCHAR(100); time timestamptz NOT NULL DEFAULT(now()));" -m postgres
